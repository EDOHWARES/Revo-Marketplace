...
export function ProductFilters({ onFilterChange, categories, farmingMethods }: ProductFiltersProps) {
  ...
  return (
    <div className="bg-white rounded-[20px] p-4 shadow-sm border border-gray-200">
      ...
      <div className="mt-6 border-b border-gray-200 pb-4">
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-between text-sm text-gray-600">
            <span className="text-green-800">${filters.priceRange[0]}</span>
            <span className="text-green-800">${filters.priceRange[1]}</span>
          </div>
        </div>
      </div>
